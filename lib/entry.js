 ...
 * @param {string} url The url associated to the entry.
 */
function Entry(entry, source, lang, url) {
...
/**
 * Returns the url associated to the entry.
 *
 * @memberOf Entry
 * @returns {string} Returns the entry's url.
 */
function getUrl() {
  return this.url;
}
